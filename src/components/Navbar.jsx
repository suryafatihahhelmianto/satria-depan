...
export default function Navbar({ isSidebarOpen, toggleSidebar }) {
  ...
  return (
    <div
      className={`fixed top-0 w-full border-b z-50 p-2 bg-green-50 justify-between items-center hidden md:flex lg:flex transition-all duration-300 ease-in-out ${
